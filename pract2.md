...
Реализуйте миниатюрный графический движок с использованием архитектуры ядро на C+SDL и интерпретатора Lua. Должен поддерживаться вывод графики на экран и ввод с клавиатуры.
